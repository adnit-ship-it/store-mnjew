<template>
  <UiSectionWrapper :class="[
    ...
    <UiSectionContainer class="flex flex-col gap-12">
      <h2 v-motion v-bind="fadeUpSubtle(100)"
        :class="[
      ...
      <div class="flex gap-12">
        <div class="flex flex-col w-full gap-8">
          <div v-motion v-bind="fadeUpSubtle(150)"
          ...
          <div v-motion v-bind="fadeUpSubtle(200)" :class="[
          ...
          <div v-motion v-bind="fadeUpSubtle(250)" :class="[
            'w-full md:w-[420px] h-[108px] rounded-[12px] flex items-center justify-center flex-col shadow-xl',
            cardBackgroundClass,
            cardBorderClass
          ]">
