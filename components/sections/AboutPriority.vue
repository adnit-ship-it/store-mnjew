    ...
    <UiSectionWrapper class="pb-8 md:pb-20 pt-6 md:pt-2">
        <UiSectionContainer class="flex flex-col items-start">
            ...
            <div class="mt-6 lg:mt-10 flex flex-col md:flex-row gap-4 md:justify-between w-full px-8 lg:px-0">
                <div v-motion v-bind="fadeUpSubtle(150)" class="flex flex-row gap-2 items-center">
                    <UiIcon 
                ...
                <div v-motion v-bind="fadeUpSubtle(200)" class="flex flex-row gap-2 items-center">
                    <UiIcon 
                        v-if="bulletPointIconSrc"
                        :src="bulletPointIconSrc" 
                        :icon-color="bulletPointIconColor"
                ...
                <div v-motion v-bind="fadeUpSubtle(250)" class="flex flex-row gap-2 items-center">
                    <UiIcon 
                        v-if="bulletPointIconSrc"
                        :src="bulletPointIconSrc" 
                        :icon-color="bulletPointIconColor"
                ...
                <div v-motion v-bind="fadeUpSubtle(300)" class="flex flex-row gap-2 items-center">
                    <UiIcon 
                        v-if="bulletPointIconSrc"
                        :src="bulletPointIconSrc" 
                        :icon-color="bulletPointIconColor"
            ...
            <div
                ...
                <div v-motion v-bind="fadeUpSubtle(350)" class="flex flex-col items-center max-w-[400px]">
                    <h3 :class="[
